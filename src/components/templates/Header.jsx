...
const Header = ({ delay = 0.4 }) => {
    ...
    const isWebPage = location.pathname.startsWith("/web/") || location.pathname === "/web"
    ...
    const getLinkClasses = (path) => {
        ...
        if (path === "/web" && isWebPage) {
            return "text-link" // web should be active when /web/*
        }
            ...
            >
                <nav className="flex items-center justify-between [&_a]:pointer-events-auto
                    ...
                    <ul className="hidden lg:flex gap-4 md:gap-10 3xl:gap-14 4xl:gap-20 6xl:gap-28">
                        <li>
                            <NavLink to="/web" className={() => getLinkClasses("/web")}>
                                Web
                            </NavLink>
                        </li>
                        <li>
