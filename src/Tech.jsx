                ...
                <section className="relative flex flex-col gap-16 md:gap-28 lg:gap-36 px-5 md:px-7 h-screen">
                    ...
                    */}
                    ...
                    <div className="xl:w-1/2 text-xl md:text-3xl lg:text-3xl 2xl:text-4xl xl:pl-5">
                        <h2 className="text-orange-400 uppercase mb-2 ml-1 min-h-7 md:min-h-9 xl:min-h-10 text-xs md:text-base lg:text-lg">
                            <EncryptionText
                                text={"// Skills"}
                                delay={0.4}
                                duration={0.75}
                        ...
                        <div className="flex flex-col gap-10 w-full text-xl
                            [&_caption]:w-fit [&_caption]:mb-2 [&_caption]:text-start [&_caption]:uppercase
                            [&_caption]:text-xl [&_caption]md:text-2xl [&_caption]:lg:text-3xl
                    ...
                    <div className="text-4xl md:text-5xl lg:text-7xl 2xl:text-8xl mb-10 md:mb-12 lg:mb-[4.5rem] 2xl:mb-24
                        xl:px-5 uppercase">
                        <h2 className="text-sky-300 uppercase mb-2 ml-1 min-h-7 md:min-h-9 xl:min-h-10 text-xs md:text-base lg:text-lg">
                            <EncryptionText
                    ...
                    <div className="xl:w-1/2 text-xl md:text-3xl lg:text-3xl 2xl:text-4xl xl:px-5">
                        <h2 className="text-purple-400 uppercase mb-2 ml-1 min-h-7 md:min-h-9 xl:min-h-10 text-xs md:text-base lg:text-lg">
                            <EncryptionText
                                text={"// Connect"}
                                delay={0.4}
                                duration={0.75}
